...
public class Auth {
    ...
    private static final String TAG = "Extended.Auth";
    ...
    public static String getDirectAuthUrl(String app_id, String client_secret, String login, String password, String settings){
        return "https://oauth.vk.com/token?grant_type=password&client_id="+app_id+"&client_secret="+client_secret+"&username="+login+"&password="+password+"&scope="+settings+ "&v="+URLEncoder.encode(Api.API_VERSION);
    }
